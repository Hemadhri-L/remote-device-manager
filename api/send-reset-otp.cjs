...
module.exports = async function handler(req, res) {
  ...
  try {
    await transporter.sendMail({
      ...
      to: email,
      subject: "Reset Your RDManager Password",
      html: `
        <div style="font-family: sans-serif; max-width: 400px; margin: 0 auto; padding: 32px; background: #0a0a0a; border-radius: 16px; border: 1px solid #222;">
          <h2 style="color: #ffffff; font-size: 22px; margin: 0 0 8px 0;">Password Reset</h2>
          <p style="color: #888; font-size: 14px; margin: 0 0 24px 0;">Enter this code to reset your password</p>
          ...
          <p style="color: #666; font-size: 12px; margin: 0;">This code expires in 5 minutes. If you didn't request this, ignore this email.</p>
        </div>
      `,
    })
